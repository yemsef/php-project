...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Contact us" href="https://api.whatsapp.com/send/?phone=%2B2347035827880&text&type=phone_number&app_absent=0" target="self" class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img class="object-cover object-center w-full h-full rounded-full" src="https://w7.pngwing.com/pngs/507/666/png-transparent-computer-icons-whatsapp-whatsapp-text-logo-silhouette-thumbnail.png"/>
        </a>
    </div>
</div>
<?php
